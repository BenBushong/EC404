...
> Welcome. Have fun. Relax. Enjoy yourself.

--

Learning sucks. It's hard, and---unlike in many courses you've taken in the past---in this course you'll _actually learn_. But this is hard.

--

You have access to a variety of tools that are extremely helpful.

Use those tools. But the most important tool remains me. (Ha, I'm a tool.)
...
A (paraphrased) sample comment from spring semester 2022:
...
Current-gen prominent behavioral economists:
	- Nava Ashraf, Botond Koszegi, Stefano DellaVigna, Ulrike Malmendier, Nick Barberis.

Current up-and-comers $\to$ Future leaders:
  - Supreet Kaur, Dmitry Taubinsky, Justin Sydnor, Josh Schwartzstein, many others!
...
This class will be fun. Probably. Maybe. Hopefully?
