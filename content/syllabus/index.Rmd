...
My office hours are 4:15 - 5:30 on Tuesdays and Thursdays. My office is 25A Marshall-Adams Hall; it is in the lower level (not quite a true basement, but close). 
...
Your grade in this course will be based on attendance + participation, assignments, three exams, and a writing project. The general breakdown for grades will be 8% for attendance, 32% for assignments, 49% for exams, and 11% for a "paper". Details on the paper will be distributed midway through the course – it is designed not to deter anyone from taking this course who might otherwise be interested.
