...
Please note that this syllabus has changed in the middle of Spring 2023 due to changes in MSU's policies. 

### Office Hours

My office hours are 5:30 - 6:30 on Thursdays. My office is 25A Marshall-Adams Hall; it is in the lower level (not quite a true basement, but close). 
...
Each exam will have a variable grading weight. As a result of changes in Spring 2023, the weights have been adjusted to the following:
...
More in-depth descriptions for all the assignments will be on the [assignments page](/assignment/). As the course progresses, the assignments themselves will be posted within that page.
...
D2L will be used sparingly---primarily for submission of assignments and distribution of grades.
...
I'm not doing letters of recommendation at the moment. It's not you, it's me. 
