...
To encourage you to actively engage with the course content, I will randomly assign in-class questions or surveys or alternative assignments. These will count toward your participation grade. Accordingly, they will **only be available in class**. I will not repeat the assignments and some will actually require you to be physically in the class.
...
- ✔+: (*22 points (110%) in gradebook*) Paper is phenomenally well-thought-out and uses advanced techniques. The project discusses some important thing that is not readily obvious. I will not assign these often.
- ✔: (*20 points (100%) in gradebook*) Paper is fine, answers a question clearly, and discusses concepts from the course. This is the expected level of performance.
- ✔−: (*10 points (50%) in gradebook*) Paper is missing large components, is poorly written, does not answer a relevant question, and/or states falsehoods. This indicates that you need to improve next time. If you receive this grade, you may revise your paper.
